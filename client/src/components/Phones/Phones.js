...
import { GetPhoneData } from "../../actions/dataActions";
...
function Phones(props) {
  ...
  const filteredRows = props.data.Phones.filter((o) =>
...
// import React, { Component, Fragment } from "react";
// import { Grid, Search, Loader, Segment } from "semantic-ui-react";
// import config from "../../config";
// import axios from "axios";
...
//   async componentDidMount() {
//     const data = await axios.get(`${config.apiUrl}/api/v1/phones`);

//     console.log(data);
//     let checkedOutPhones = data.data.phones.filter(
//       (item) => item.checkedOut === true
//     );
//     this.setState({
//       phones: checkedOutPhones,
//       loading: false,
//     });
//   }
...
//       item.phoneIMEI.toLowerCase().includes(this.state.search.toLowerCase())
//     );
//   };
...
//                 </Grid.Row>
//               </Grid>
//               <PhoneList phones={this.phoneDynamicSearch()} />;
//             </Fragment>
//           </div>
//         )}
//       </Fragment>
